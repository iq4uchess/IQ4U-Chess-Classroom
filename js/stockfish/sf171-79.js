var Sf17179Web = (() => {
    ...
    return (
        async function(moduleArg = {}) {
            ...
            function Pa() {
                l ? startWorker(h) : (h.noFSInit || Qa || (Qa = !0, Ra("/dev/tty", "/dev/stdin"), Ra("/dev/tty", "/dev/stdout"), Ra("/dev/tty1", "/dev/stderr"), Sa("/dev/stdin", 0), Sa("/dev/stdout", 1), Sa("/dev/stderr", 1)), C.E(), Ta = !1)
            }
            var D = 0,
                G = null;
            ...
            function Gb() {
                ...
                } else a = new Worker(new URL("sf171-79.js", import.meta.url), {
                    type: "module",
                    name: "em-pthread"
                });
                H.push(a)
            ...
            var bb = (a, b, c, d) => {
                ...
                dc = a => {
                    var b = "/" === a.charAt(0),
                        c = "/" === a.slice(-1);
                    (a = cc(a.split("/").filter(d => !!d), !b).join("/")) ||
                    b || (a = ".");
                    a && c && (a += "/");
                    return (b ? "/" : "") + a
                },
                ...
                S = {
                    ...
                    aa: {
                        ...
                        write(a, b, c, d, e, f) {
                            ...
                            if (a.ba.subarray &&
                                b.subarray) a.ba.set(b.subarray(c, c + d), e);
                            else
                                for (f = 0; f < d; f++) a.ba[e + f] = b[c + f];
            ...
            function sc(a, b) {
                var c = 16384 === (a.mode & 61440) ? (c = Ac(a, "x")) ? c : a.ca.ta ? 0 : 2 : 54;
                if (c) throw new R(c);
            ...
            function db(a, b, c) {
                ...
                try {
                    ...
                    switch (b) {
                        ...
                        case 21523:
                            if (!d.da) return -59;
                            d.da.na.ab && (f = [24, 80], e = O(), Ea()[e >> 1] = f[0], Ea()[e + 2 >> 1] = f[1]);
                            return 0;
                        case 21524:
                            return d.da ? 0 : -59;
                        case 21515:
            ...
            var fb = () => Va(""),
                ...
                La = a => {
                    "function" === typeof Atomics.ib && (Atomics.ib(A(), a >> 2, a).value.then(Na), a += 128, Atomics.store(A(), a >> 2, 1))
                },
                Na = () => {
                    var a = Xb();
                    a && (La(a), Lc(Mc))
                ...
                ib = (a, b, c, d, e) => {
                    ...
                    Nc.length =
                        d;
                    b = e >> 3;
                    for (c = 0; c < d; c++) Nc[c] = w[b + 2 * c] ? w[b + 2 * c + 1] : Fa()[b + 2 * c + 1];
                    return (0, Oc[a])(...Nc)
                },
                jb = () => {
                    K = 0
            ...
            var Sc = () => {
                    Sc.Ia || (Sc.Ia = {});
                    Sc.Ia["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (Sc.Ia["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, q("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"))
                },
                pb = () => {
                    k || (Sc(), Va("Blocking on the main thread is not allowed by default. See https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"))
                },
                qb = () => {
                    K += 1;
                    throw "unwind";
            ...
            var Oc = [Cb, Ob, bc, cb, db, eb, mb, vb, wb, yb, zb, Ab, Bb],
                ab, C = await (async function() {
                    ...
                    Wa ??= h.locateFile ? h.locateFile ? h.locateFile("sf171-79.wasm", p) : p + "sf171-79.wasm" : (new URL("sf171-79.wasm", import.meta.url)).href;
                    try {
                        var c = await Za(b);
            ...
            var qa = h._uci = a => (qa = h._uci = C.H)(a),
                ...
                Xb = () => (Xb = C.L)(),
                Wc = h.__emscripten_proxy_main = (a, b) => (Wc = h.__emscripten_proxy_main = C.M)(a, b),
                Pb = () => (Pb = C.O)(),
